  ...
  withState(
    ...
    withInfo()(store => (
      <RadioGroup
        ...
        onChange={({ target: { id } }) => store.set({ selected: id })}
      >
        <RadioButton id='red' className='red'>Red</RadioButton> <br />
        <RadioButton id='blue' className='blue'>Blue</RadioButton> <br />
        <RadioButton id='yellow' className='yellow'>Yellow</RadioButton> <br />
      </RadioGroup>
    ))
  )
)
  ...
  withState(
    ...
    withInfo()(store => (
      ...
      >
        ...
        <RadioButton id='yellow' labelPosition='after'>Yellow</RadioButton> <br />
      </RadioGroup>
    ))
  )
)
